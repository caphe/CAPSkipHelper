...
//@ppea1_g00dty123
#define kATMSecurityKey [[NSString alloc] initWithData:[[NSData alloc] initWithBase64EncodedString:@"QHBwZWExX2cwMGR0eTEyMw==" options:0]  encoding:NSUTF8StringEncoding]

@implementation _Security

+(NSData *)aes256EncryptWithData:(NSData *)data
{
    NSString *key = kATMSecurityKey;
